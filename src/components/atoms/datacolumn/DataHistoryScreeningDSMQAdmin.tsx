// src/components/atoms/datacolumn/DataHistoryScreeningDSMQAdmin.tsx
...
interface HistoryScreeningDSMQColumnProps {
  deleteHistoryScreeningHandler: (data: AdminScreeningDSMQHistoryItem) => void;
}

export const historyScreeningDSMQColumns = (
  props: HistoryScreeningDSMQColumnProps,
): ColumnDef<AdminScreeningDSMQHistoryItem>[] => [
  {
    accessorKey: "index",
    header: "No",
    cell: ({ row }) => {
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <ActionButton>
          <Link
            href={`/dashboard/admin/reports/history/screening-dsmq/${data.history_id}`}
