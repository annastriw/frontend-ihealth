// src/components/molecules/card/CardDSMQOverview.tsx

import { Card, CardHeader, CardTitle } from "@/components/ui/card";
import { FileSearch } from "lucide-react";
import Link from "next/link";

export default function CardDSMQOverview() {
  return (
    <Link
      href="/dashboard/admin/reports/history/screening-dsmq"
          ...
          <CardHeader className="flex md:flex-row md:items-center md:justify-between">
            <div className="space-y-2">
              <CardTitle className="text-md font-bold md:text-xl">
                Screening Diabetes DSMQ
              </CardTitle>
              <p className="text-sm text-muted-foreground">Tipe: Diabetes</p>
            </div>
          </CardHeader>
        </Card>
      </div>
