  ...
  return (
    <div className="relative flex h-screen flex-col md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
      ...
      <motion.div
        ...
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.6 }}
        className="bg-background flex h-full items-center justify-center px-4 py-8 sm:px-6 md:px-10 lg:px-16"
      >
        <motion.div
        ...
        >
          ...
          <div className="group mb-2 flex justify-center transition-all duration-300 lg:hidden">
            <Link
              href="/"
              className="flex items-center gap-3 transition-all hover:opacity-90"
            >
