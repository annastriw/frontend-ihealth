    ...
    <div className="mb-6">
      <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-lg transition-shadow hover:shadow-xl">
        ...
        <p className="mb-4 text-sm text-gray-600">
          Lihat hasil screening dan riwayat diabetes melitus Anda
        </p>
        <div className="flex flex-col sm:flex-row gap-3">
          <Link
            href="/dashboard/diabetes-melitus/hasil-screening"
...
function ModulePlaceholder() {
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-6">
      <h2 className="text-xl font-bold text-gray-900 mb-4">Modul Edukasi Diabetes Melitus</h2>
      <p className="text-gray-600 mb-6">
        Pembelajaran Diabetes Melitus terdiri dari beberapa tahapan penting, yaitu screening 
...
function DynamicModuleWrapper() {
  ...
  return <ModuleComponent type="diabetes-melitus" withScreening />;
}
