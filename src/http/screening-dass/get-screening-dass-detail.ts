...
export async function getScreeningDASSDetail(id: string, token: string): Promise<ScreeningDASSDetail> {
  const res = await axios.get(`http://localhost:8000/api/screening-dass-histories/${id}`, {
